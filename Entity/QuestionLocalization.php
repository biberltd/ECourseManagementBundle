 ...
 *     uniqueConstraints={
 *         @ORM\UniqueConstraint(name="idx_u_question_localization", columns={"question","language"}),
 *         @ORM\UniqueConstraint(name="idx_u_question_localization_url_key", columns={"language","url_key"})
 *     }
 * )
 */
class QuestionLocalization extends CoreEntity
{
    /** 
     ...
     * @ORM\Id
     * @ORM\ManyToOne(
     *     targetEntity="BiberLtd\Core\Bundles\ECourseManagementBundle\Entity\Question",
