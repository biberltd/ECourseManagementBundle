 ...
 *     uniqueConstraints={
 *         @ORM\UniqueConstraint(name="idx_u_course_localization", columns={"course","language"}),
 *         @ORM\UniqueConstraint(name="idx_u_course_localization_url_key", columns={"course","language","url_key"})
 *     }
 * )
 */
class CourseLocalization extends CoreEntity
{
    /** 
     ...
     * @ORM\Id
     * @ORM\ManyToOne(
     *     targetEntity="BiberLtd\Core\Bundles\ECourseManagementBundle\Entity\Course",
